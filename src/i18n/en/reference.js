export default {
  ...
  changelog: {
    ...
    // v0.1.46.0
    cl_commission_percent_mode: "New: commission revenue streams accept a percentage rate (rate × average transaction value) in addition to the fixed amount per transaction.",
