...
var ROADMAP = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "floating_toolbar", label: { fr: "Toolbar flottante (dock modules)", en: "Floating toolbar (module dock)" }, desc: { fr: "Barre flottante bottom-center style Dynamic Island / macOS dock. Backdrop blur + transparence. Icônes des modules (pages/apps) avec navigation rapide. Auto-shrink après inactivité curseur (best practice Apple action bar). Notifications au-dessus (badges, dots, toasts). Animation GSAP : expand au hover, shrink après X ms sans interaction. Position fixed, z-index élevé. Pattern référence : Linear command bar, Arc browser toolbar, Apple floating action bar iOS 18.", en: "Floating bottom-center bar, Dynamic Island / macOS dock style. Backdrop blur + transparency. Module icons with quick nav. Auto-shrink on cursor inactivity. Notifications above (badges, dots, toasts). GSAP animations. References: Linear, Arc browser, Apple iOS 18 action bar." }, status: "todo", priority: "high" },
