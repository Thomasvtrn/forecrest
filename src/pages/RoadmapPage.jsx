...
var ROADMAP = [
  {
    ...
    items: [
      { id: "income_statement", label: { fr: "Compte de résultat prévisionnel", en: "Projected income statement" }, desc: { fr: "P&L normalisé PCMN (classes 6-7) sur 12, 24 et 36 mois. Toutes les données existent dans App.jsx.", en: "PCMN-normalized P&L (classes 6-7) for 12, 24, 36 months. All data exists in App.jsx." }, status: "todo", priority: "high" },
      { id: "balance_sheet", label: { fr: "Bilan prévisionnel", en: "Projected balance sheet" }, desc: { fr: "Bilan d'ouverture + à 12 et 24 mois (micro-schéma CSA Art. 3:3). Actif/Passif depuis équipements, dettes, config.", en: "Opening + 12/24 months balance sheet. Assets/Liabilities from equipment, debts, config." }, status: "todo", priority: "high" },
